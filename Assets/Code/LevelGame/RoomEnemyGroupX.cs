...
public class RoomEnemyGroupX : RoomGameplayBase
{
    ...
    public override void Build(MazeGameManager.RoomInfo room)
    {
        ...
        if (r2 == r1)
            r2 = 3;
        //print("X: " + r1 + "_" + r2);
        GameObject o1 = SpawnEnemyGroupObject(eInfos1, room.vCenter + shifts[r1], width, height, room.mainRatio);
        GameObject o2 = SpawnEnemyGroupObject(eInfos2, room.vCenter + shifts[r2], width, height, room.mainRatio);
