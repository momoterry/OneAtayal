...
public partial class @MyInputActions: IInputActionCollection2, IDisposable
{
    ...
    private List<ITheHeroActions> m_TheHeroActionsCallbackInterfaces = new List<ITheHeroActions>();
    ...
    public struct TheHeroActions
    {
        ...
        public void AddCallbacks(ITheHeroActions instance)
        {
            if (instance == null || m_Wrapper.m_TheHeroActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_TheHeroActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(ITheHeroActions instance)
        {
            @Move.started -= instance.OnMove;
            @Move.performed -= instance.OnMove;
            @Move.canceled -= instance.OnMove;
        ...
        public void RemoveCallbacks(ITheHeroActions instance)
        {
            if (m_Wrapper.m_TheHeroActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(ITheHeroActions instance)
        {
            foreach (var item in m_Wrapper.m_TheHeroActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_TheHeroActionsCallbackInterfaces.Clear();
