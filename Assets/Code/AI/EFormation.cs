    ...
    protected void BuildMiddleSlots()
    {
        ...
        for (int c = 0; c < nCircle; c++)
        {
            ...
            for (int l = 0; l < nLine; l++)
            {
                ...
                //middleList[i].GetSlot().localPosition = new Vector3(-width, 0, fPos);  //オ

                Vector3 pos = new Vector3(-width, 0, fPos);  //オ
                ...
                if (i < middleNum)
                {
                    //middleList[i].GetSlot().localPosition = new Vector3(width, 0, fPos);   //
                    pos = new Vector3(width, 0, fPos);   //
